  ...
  return (
    <div className="flex items-center justify-center min-h-screen">
      <div className="w-full max-w-md bg-white shadow-xl rounded-lg p-8 flex flex-col items-center mx-4">
        ...
        <form onSubmit={handleSubmit} className="w-full">
          ...
          <div className="mb-6 flex items-center">
            <input
              id="remember-me"
              type="checkbox"
              className="mr-2 h-4 w-4 accent-blue border-2 border-blue-900"
              name="rememberMe"
            />
        ...
        <a className="text-sm self-start text-sky-700" href="/forgot-password">
